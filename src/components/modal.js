        ...
        <ProductConsumer>
            {(object)=>{
                ...
                else
                {
                    return(
                        <React.Fragment>
                            <div style={{backgroundColor:"lightgray",width:"100%",height:"100%",position:"fixed",bottom:"0.01%",right:"1%",opacity:"0.95"}}>
                                <div style={{boxShadow:"0.08rem 0.08rem 0.08rem 0.08rem darkgray",backgroundColor:"#f3f3f3",position:"fixed",bottom:"5%",left:"35%"}}>
                                    <br/>
