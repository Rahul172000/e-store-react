  ...
  return(
    <React.Fragment>{/*The enclosing element and thus we don't use any extra element*/}
      <div className="row header" style={{backgroundColor:"#2a2a72",height:"8%",marginBottom:"10%"}}>
        <div className="col-lg-2 col-md-2 col-sm-2 col-2 text-center" style={{marginTop:"0.4%",height:"8%"}}><Link to="/"><img src={logo}/></Link></div>
        <div className="col-1" style={{marginTop:"0.8%",height:"8%"}}><Link to="/" exact strict><span style={{color:"#f3f3f3",fontSize:"15pt"}}>PRODUCTS</span></Link></div>
        <div className="col-lg-6 col-md-6 col-sm-5 col-4" style={{height:"5%"}}></div>
        <div className="col-lg-2 col-md-3 col-sm-3 col-4" style={{marginTop:"0.8%",marginBottom:"9%"}}><Link to="/cart" exact strict><button className="btn btn-outline-info"><span className="fas fa-shopping-cart"></span> MY CART</button></Link></div>
